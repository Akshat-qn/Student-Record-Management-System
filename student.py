...
class std():
    def __init__(self,root):
        ...
        title = tk.Label(self.root, text="Student Record Management System",bd=4, relief="raised", bg="light pink", font=("Nyala",40,"bold","italic"))
        title.pack(side="top", fill="x")

        #option frame

        optFrame = tk.Frame(self.root, bd=5, relief="ridge", bg=self.clr(230,150,200))
        optFrame.place(width=self.width/3-80, height=self.height-250, x=60, y=140)
        ...
        addBtn.grid(row=0, column=0, padx=40, pady=35)
    ...
    def addFrameFun(self):
        ...
        self.addFrame.place(width=self.width/3-100, height=self.height-350, x=self.width/3+80,y=100)
    ...
    def addFun(self):
        ...
        if rn and name and fname and sub and grade:
           ...
           try:
            ...
            tk.messagebox.showerror("Error","Please fill all input field !")

    def searchFrameFun(self):
        self.addFrame = tk.Frame(self.root, bd=5, relief="ridge", bg=self.clr(150,180,250))
        self.addFrame.place(width=self.width/3-100, height=self.height-420, x=self.width/3+80,y=100)
    ...
    def dbFun(self):
        self.con = pymysql.connect(host="localhost", user="root",passwd="1234", database="record")
    ...
    def delframeFun(self):
        self.addFrame = tk.Frame(self.root, bd=5, relief="ridge", bg=self.clr(150,180,250))
        self.addFrame.place(width=self.width/3-100, height=self.height-650, x=self.width/3+80,y=100)
